export default class CustomerService {
    ...
    getCustomersLarge() {
        return fetch('/demo/data/customers-x-large.json').then(res => res.json())
                .then(d => d.data);
    }
    ...
    getCustomers(params) {
        ...
        return fetch('https://www.primefaces.org/showcase/demo/data/customers?' + queryParams).then(res => res.json())
    }
}