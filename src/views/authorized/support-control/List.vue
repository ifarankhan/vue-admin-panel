<template>
  ...
  <div class="px-8" v-if="!alreadyMember">
   <div class="flex flex-col items-center justify-center" style="height: 60vh">
     <div>
       <h1 class="mt-6 mb-8 ml-3 text-2xl font-normal leading-tight">Welcome to the psytech Support System</h1>
     </div>
     <div>
       <psytech-button
  ...
  <div class="px-8" v-else>
    <sticky-header>
      <h1 class="mt-6 mb-8 ml-3 text-2xl font-normal leading-tight">Support System</h1>
